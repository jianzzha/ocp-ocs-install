...
$ocos delete --timeout=5s pv --all || exit 1
$ocos delete pvc --all || exit 1
...
ssh core@baremetal 'for d in nvme0n1; do sudo pvremove --force /dev/$d ; sudo sgdisk -Z /dev/$d; done'
